...
I need to consider among the expenses (see [[TestiOnline.fi#Foreseeable Expenses]]) the necessity to hire a Commercialista from when I start accepting transaction since there might be complicated financial and administrative issues with taxes and registrations.
#### Step 2. The Website
